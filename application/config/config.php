...
|
*/
$config['sess_driver'] = ((getenv('CI_ENV') ?: ENVIRONMENT) === 'production') ? 'files' : 'database';
$config['sess_cookie_name'] = 'ci_session';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = ((getenv('CI_ENV') ?: ENVIRONMENT) === 'production') ? sys_get_temp_dir() : 'ci_sessions';
